...
public class Completed {
	...
	public void access_C() throws InterruptedException {
		Thread.sleep(4000);
	...
	public void accessProjects_C() throws InterruptedException {
	...
	public void Completedtab_viewfilter() throws InterruptedException {
		// Assigned tab
		WebElement viewfilter = driver.findElement(By.xpath("//i[contains(@title,'View filters option')]"));// completed>>view
																											// filter
																											// options
		viewfilter.click();
		Thread.sleep(6000);
	...
	public void Completedtab_priorityfilter() throws InterruptedException {
		// Assigned tab
...
//	    	  desiredOption.click();
	...
	public void Assignedtab_ownerfilter() throws InterruptedException {
		// Assigned tab
		// select owner filter
		WebElement comp_dropdown_owner = driver
	...
	public void Completedtab_projectfilter() throws InterruptedException {
		// Assigned tab
	...
	public void Completedtab_Appointmnetfilter() throws InterruptedException {
		// Assigned tab
		// due date
		try {
	...
	/*
	 * @Test(priority=12,dependsOnMethods = "mylogin", enabled=true) public void
	 * Assignedtab_Appointmnetfilter() throws InterruptedException { //Assigned tab
	 * //Appointmnet date WebElement calendar_apptdate = driver.findElement(By.
	 * xpath("(//span[contains(@class,'k-icon k-i-calendar')])[2]"));
	 * calendar_apptdate.click(); Thread.sleep(4000);
	 * driver.findElement(By.xpath("//span[contains(.,'TODAY')]")).click();
	 * Thread.sleep(4000);
	 * driver.findElement(By.xpath("//button[@id='btnApplyFilter']")).click();
	 * driver.findElement(By.id("btnClearFilter")).click(); Thread.sleep(4000); }
	 */
	@Test(priority = 13, dependsOnMethods = "mylogin", enabled = true)
	public void completedtab_ExporttoeExcel() throws InterruptedException {
		try {
			driver.findElement(By.xpath("//button[@type='button'][contains(.,'Export to Excel')]")).click();
			Thread.sleep(4000);
	...
	public void Completedtab_projectdeatils() throws InterruptedException {
		try {
			driver.findElement(By.xpath("(//a[@class='ng-star-inserted'])[1]")).click(); // project details open
			Thread.sleep(4000);

			driver.findElement(By.xpath("//span[@class='k-link ng-tns-c402-5'][contains(.,'Instructions(Total: 0)')]"))
					.click();// Summary
			Thread.sleep(4000);
			...
			System.out.println("No data found on the grid/xpath failuar");
	...
	public void completedtab_scrollbar() throws InterruptedException {
		// Create an instance of JavascriptExecutor
		try {
			JavascriptExecutor jsopenc = (JavascriptExecutor) driver;

			// Scroll down by pixel
			jsopenc.executeScript("window.scrollBy(0, 500);");
			Thread.sleep(4000);
